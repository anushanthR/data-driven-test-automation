...
/**
 * @PreparedBy ThusyaG_RECRUITMENT PAGE_TESTS
 */
public class RecruitmentTest extends TestBase {
    ...
    public void addCandidates(String Firstname,String Middlename,String Lastname,String Mail,String ContactNumber,String jobVacancy,String keyWord,String comment,String dateofApplication) {
        softAssert = new SoftAssert();
        softAssert.assertTrue(LoginPage.isLoginPageDisplay(), "Login Page is not Displayed");
        LoginPage.login(Constants.OrgUserName, Constants.LOGIN_PASSWORD);
    ...
    public void searchCandidates(String CanJobTitle, String CanVacancy, String CanHiringManager, String CanStatus, String CanName, String CanKey, String fromDate, String toDate, String CanMethodApplication) {
        ...
        softAssert.assertTrue(RecruitmentSearchCandidate.isCandidateJobTitleDropDownDisplayed(), "DropDown is not Displayed");
        RecruitmentSearchCandidate.RecruitmentCanSearchForm(CanJobTitle, CanVacancy, CanHiringManager, CanStatus, CanName, CanKey, fromDate, toDate, CanMethodApplication);
