...
public class GeneralTestData extends TestBase {
    private static final Logger LOGGER = Logger.getLogger(GeneralTestData.class);

    @Test(groups = "REGRESSION", priority = 13, dataProviderClass = GeneralInformation_data.class, dataProvider = "GenderalInformation")
