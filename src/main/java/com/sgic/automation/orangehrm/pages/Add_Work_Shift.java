...
public class Add_Work_Shift extends PageBase {
    private  static final Logger LOGGER = Logger.getLogger(Add_Work_Shift.class);
    ...
    public static void Add_Work_Shift(String name, String ftime, String ttime, String aemployee){
        Add_Work_Shift.clickAddButton();
        Add_Work_Shift.isJobWork_shift_HeaderHeaderDisplay();
        LOGGER.info("Show Is Work Shift Header");
        Add_Work_Shift.setShift_name(name);
        LOGGER.info("Add Is Shift Name");
        Add_Work_Shift.setFrome_time(ftime);
        LOGGER.info("Add Is Frome Time");
        Add_Work_Shift.setTo_Time(ttime);
        LOGGER.info("Add Is End Time");
        Add_Work_Shift.setAvilable_Employee(aemployee);
        LOGGER.info("Add Is Avalabil Employee");
        Add_Work_Shift.clickAdd_Employee();
        LOGGER.info("Add Is Avalabil Button Employee");
        Add_Work_Shift.clickSave();
        LOGGER.info("Add Is Save Button Employee");
    }
