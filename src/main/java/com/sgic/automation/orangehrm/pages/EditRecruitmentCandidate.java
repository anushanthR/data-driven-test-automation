...
public class EditRecruitmentCandidate extends PageBase {
    ...
    private static By editCandidateLink = By.xpath("//*[@id=\"resultTable\"]/tbody/tr[1]/td[3]/a");
    private static By editCanBtn = By.xpath("//*[@id=\"btnSave\"]");
    ...
    public static boolean EditLinkLVerify(){return getDriver().findElement(editCandidateLink).isDisplayed();}
    public static void setEditCandidateLink(){getDriver().findElement(editCandidateLink).click();
        LOGGER.info("edit link clicked ");}
    public static void setEditCanBtn(){getDriver().findElement(editCanBtn).click();}
    ...
    public static void AddCandidateForms(String Firstname,String Middlename,String Lastname,String Mail,String ContactNumber,String jobVacancy,String keyWord,String comment,String dateofApplication){
        ...
        EditRecruitmentCandidate.firstName(Firstname);
        EditRecruitmentCandidate.middleName(Middlename);
        EditRecruitmentCandidate.lastName(Lastname);
        EditRecruitmentCandidate.setEmail(Mail);
        EditRecruitmentCandidate.setContactNum(ContactNumber);
        EditRecruitmentCandidate.setjobVacancySelectedOption(jobVacancy);
        EditRecruitmentCandidate.setKeyword(keyWord);
        EditRecruitmentCandidate.setComment(comment);
        EditRecruitmentCandidate.setDateOfApplication(dateofApplication);
    }
}
